...
<body>
  ...
  <div class="entry" id="fgt" style="display:block;">
    <div class="login fgt_login">
      ...
      <form class="signin" action="includes/reseTokenSubmit.php" method="post">
        ...
        <?php
          if (isset($_GET['selector'])) {
            ...
            if (!empty($_GET['selector'])) {
              ?>
              <input type="text" name="reqSelector" value="<?php echo $_GET['selector']; ?>">
              <?php
        ...
        <div class="field">
          <input type="text" name="reqPwd" id="number" value="" required>
          <label for="number" class="lab">Create New Password</label>
        </div>
        <div class="field">
          <input type="text" name="reqRpwd" id="number" value="" required>
          <label for="number" class="lab">Enter Password Again</label>
        </div>
